| Version | Documents |
|:---:|---|
| 0.2.4-SNAPSHOT | [API documentation](0.2.4-SNAPSHOT)<br>[API class diagram](0.2.4-SNAPSHOT/api_class_diagram.svg) |
| **0.2.4 (latest stable)** | [API documentation](latest-stable)<br>[API class diagram](0.2.4/api_class_diagram.svg) |
| 0.2.3 | [API documentation](0.2.3)<br>[API class diagram](0.2.3/api_class_diagram.svg) |
